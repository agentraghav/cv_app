...
function Struct() {
  ...
  return (
    <div>
      ...
      <div>
        {nameEdit ? <Name done={editName} /> : <NameSet done={editName} />}{' '}
        <button
          className='e-button'
      ...
      <div className='info-set'>
        ...
        <div>
          {infoEdit ? (
            <InfoInput done={editInfo} />
          ) : (
            <InfoSet done={editInfo} />
          )}{' '}
          <button
            className='e-button'
            style={{ marginTop: '10px' }}
      ...
      <div className='gap'>
        ...
        <div>
          {eduEdit ? <EduInput done={editEdu} /> : <EduSet done={editEdu} />}
          <button
            className='e-button'
            style={{ marginTop: '10px' }}
            onClick={editEdu}>
      ...
      <div className='gap'>
        ...
        <div>
          {expEdit ? <ExpInput done={editExp} /> : <ExpSet done={editExp} />}
          <button
            className='e-button'
            style={{ marginTop: '10px' }}
            onClick={editExp}>
      ...
      <div className='gap'>
        ...
        <div>
          {skillEdit ? (
            <SkillInput done={editSkill} />
          ) : (
            <SkillSet done={editSkill} />
          )}
          <div>
            <button
              className='e-button'
